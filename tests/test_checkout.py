...
DUMMY_WEBHOOK_SECRET = 'whsec_dDaN58M6BzFkNobyQFmtx2Q8xMjNpmuf'
DUMMY_CUSTOMER_ID = 'ccus_JjHctnd9PxV2Dt' # If you're making live requests, this should be a real customer ID
TEST_CUSTOMER_EMAIL = 'venx.rao87@gmail.com' # This email should correspond to the email on file for the customer ID above
...
@vcr.use_cassette('tests/cassettes/test_get_customer.yaml',
